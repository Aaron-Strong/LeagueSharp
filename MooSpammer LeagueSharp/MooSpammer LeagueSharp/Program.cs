    ...
    internal class Program
    {
            ...
            Config.SubMenu("ButtonToSpam")
                ...
                .SetValue(
                    new StringList(
                        new[]
                        {
                            "jQuery", "Detection", "MikuDidThis", "Media Tilts Me", "Memes", "Apes", "jQuery2", "Degrec",
                            "Suck", "You suck", "Exory", "PlsStop", "T I L T E D", "Moo", "Royals", ":ro:", "'TeamMoo",
                            "Blacky"
                        }
                    ));
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            if (Config.Item("Press Button").GetValue<KeyBind>().Active)
            {
                ...
                switch (Config.Item("ChatType").GetValue<StringList>().SelectedIndex)
                {
                    case 0:
                        Game.Say(
                            $"{all} jQuery is an adorable cutie but remember she is only 15 years old. How can you post your s... picture named by her name ?? ");
                        Game.Say(
                            $"{all} Well if you're under 18y old, I could agree the fact you need to be medically suived but I will never agree to post those shit ... ");
                    ...
                    case 5:
                        Game.Say(
                            $"{all} Can you  A P E S start trying to play good? This game is boring the S H I T out of me. F U C K Y O U E A T M Y D I C K");
                        AmountSpammed++;
                        break;
                    ...
                    case 10:
                        Game.Say(
                            $"{all} I would clap at my brain after pulling off such a masterpiece of a phrase, if it wasn't shit.");
                        AmountSpammed++;
                        break;

                    case 11:
                        Game.Say(
                            $"{all} Guys can you please not spam the chat. My mom bought me this new laptop and it gets really hot when the chat is being spamed. Now my leg is starting to hurt because it is getting so hot. Please, if you don’t want me to get burned, then dont spam the chat");
                        AmountSpammed++;
                        break;
...

            {
                ...
                case ".lobby":
                    ...
                    Utility.DelayAction.Add(3000,
                        () => Game.Say($"{all} Follow {text} on TheTechGame & SevenSins @{text}"));
                    Utility.DelayAction.Add(4000,
                    ...
                    Utility.DelayAction.Add(11000,
                        () => Game.Say($"{all} And incase you get banned we also sell accounts at"));
                ...
                case ".icy":
                    ...
                    Utility.DelayAction.Add(10000,
                        () => Game.Say($"{all} you know, the relaxation sounds spacebar actually gives off "));
                    Utility.DelayAction.Add(11000,
                        () =>
                            Game.Say(
                                $"{all} also you know what you can do with a spacebar, which if you have leaguesharp is a lot. "));
                    ...
                    Utility.DelayAction.Add(22000,
                        () => Game.Say($"{all} ight, so the second one we gonna do is we're gonna"));
                    ...
                    Utility.DelayAction.Add(27000,
                        () => Game.Say($"{all} and uhh like i said i hope you guys can here this honestly. "));
                    ...
                    Utility.DelayAction.Add(32000,
                        () => Game.Say($"{all} you know when you need to, say harass an enemy "));
                    Utility.DelayAction.Add(33000, () => Game.Say($"{all} or you could hold the C key. "));
                    Utility.DelayAction.Add(34000,
                        () => Game.Say($"{all} Let me just go and hold the C key for you guys "));
                    ...
                    Utility.DelayAction.Add(40000,
                        () => Game.Say($"{all} See, there's a different, there's a different pitch. "));
                    ...
                    Utility.DelayAction.Add(49000,
                        () => Game.Say($"{all} C key, spacebar, C key, spacebar, spacebar, spacebar (etc etc) "));
                    Utility.DelayAction.Add(50000, () => Game.Say($"{all} Okay so the third mode is "));
                    Utility.DelayAction.Add(51000,
                        () => Game.Say($"{all} i'm gonna basically be spamming the spacebar "));
                    ...
                    Utility.DelayAction.Add(57000,
                        () => Game.Say($"{all} and this, that mode, awhh it just sounds great, "));
                    ...
                    Utility.DelayAction.Add(65000,
                        () =>
                            Game.Say(
                                $"{all} if you're not feeling relaxed then i don't know what to tell you really."));
                    ...
                    Utility.DelayAction.Add(69000,
                        () => Game.Say($"{all} Once again it's been your boy icy have a good night and peace. "));
                    AmountSpammed += 69;
                    break;
                ...
                case ".giveaway":
                    Game.Say(
                        "1 MONTH FREE SUBSCRIPTION: https://www.joduska.me/forum/topic/207998-1-month-leaguesharp-subscription-giveaway-anyone-can-join/");
                    AmountSpammed++;
                    break;
                ...
                case ".amount":
                    Game.Say("");
                    Game.PrintChat($"You have spammed {AmountSpammed} times, wow!");
        ...
        private static void JsonMenu()
        {
            ...
            Config.SubMenu(ObjectManager.Player.ChampionName)
                .AddItem(new MenuItem($"{ObjectManager.Player.ChampionName} Hotkey",
                    $"{ObjectManager.Player.ChampionName} Hotkey"))
        ...
        private static void customSpamSingleLogic(string customText)
        {
            var Lines = 0;
            var spam = "Error";
            var regexMatch = Regex.Match(customText, "\\d");

            if (regexMatch.Success)
            {
                var digitStartIndex = regexMatch.Index;
        ...
        private static readonly SoundPlayer wow_hawk = new SoundPlayer(Resources.wow_hawk);
        private static readonly SoundPlayer wow_icy = new SoundPlayer(Resources.wow_icy);
