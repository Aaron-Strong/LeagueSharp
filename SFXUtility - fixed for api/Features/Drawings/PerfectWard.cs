...
namespace SFXUtility.Features.Drawings
{
    internal class PerfectWard : Child<Drawings>
    {
        ...
        private List<int> _greenWards;
        private float _lastCheck;
        private SpellSlot _lastWardSlot;
        private WardSpot _lastWardSpot;
        private List<int> _pinkWards;
        private List<WardSpot> _wardSpots;
        public PerfectWard(SFXUtility sfx) : base(sfx) {}
        ...
        protected override void OnInitialize()
        {
            ...
            _lastWardSlot = default(SpellSlot);
            _lastWardSpot = default(WardSpot);
            _greenWards = new List<int>
            {
            ...
            _pinkWards = new List<int> { ItemData.Stealth_Ward.Id, ItemData.Greater_Stealth_Totem_Trinket.Id };

            // Credits: DrunkenNinja

            #region Ward Spots

            _wardSpots = new List<WardSpot>
            {
